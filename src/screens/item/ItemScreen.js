...
class ItemScreen extends Component {
  static defaultProps = {
    InterestItem: [
      {name: '推荐',id: '001',category: 'hotnews'},
      {name: '科技',id: '002',category: 'technews'},
      {name: '金融',id: '003',category: 'financenews'},
      {name: '地产',id: '004',category: 'housenews'},
      {name: '发现',id: '005',category: 'findnews'},
    ],
    totalItem:[
      {name: '推荐',id: '001',category: 'hotnews'},
      {name: '科技',id: '002',category: 'technews'},
